...
<?php if ( sizeof( WC()->cart->get_cart() ) > 0 ) : ?>
	...
	<p class="total"><strong>Gesamt Zwischensumme:</strong> <?php echo WC()->cart->get_cart_subtotal(); ?></p>

	<?php //do_action( 'woocommerce_widget_shopping_cart_before_buttons' ); ?>

	<p class="buttons">
		<a href="<?php echo WC()->cart->get_cart_url(); ?>" class="btn btn-outline btn-sm wc-forward">Warenkorb ansehen</a>
		<a href="<?php echo WC()->cart->get_checkout_url(); ?>" class="btn btn-outline btn-sm checkout wc-forward"><?php _e( 'Checkout', 'woocommerce' ); ?></a>
	</p>
