        ...
        ?>
            <div id="cart" class="dropdown">
                ...
                <a class="dropdown-toggle mini-cart" data-toggle="dropdown" aria-expanded="true" role="button" aria-haspopup="true" data-delay="0" href="#" title="Warenkorb ansehen">
                    <span class="title-cart"><?php _e('Warenkorb ',TEXTDOMAIN); ?></span>
                    <?php echo sprintf(_n(' <span class="mini-cart-items"> %d Artikel </span> ', ' <span class="mini-cart-items"> %d Artikel - </span> ', $woocommerce->cart->cart_contents_count, 'woothemes'), $woocommerce->cart->cart_contents_count);?> <?php echo $woocommerce->cart->get_cart_total(); ?>
                </a>
...
function wpo_wcqi_remove_css(){
    wp_dequeue_style('wcqi-css');
}
add_action('wp_enqueue_scripts', 'wpo_wcqi_remove_css', 99);
