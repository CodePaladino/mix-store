...
?>
<div class="thumbnail text-center product product-grid product-block style-cd">
	<figure class="image">
        ...
        <?php if(wpo_theme_options('is-quickview', true)){ ?>
            <div class="quick-view">
                <a href="#" class="quickview btn btn-outline-inverse btn-outline-sm" data-productslug="<?php echo $product->post->post_name; ?>" data-toggle="modal" data-target="#wpo_modal_quickview">
                ...
                <div class="action-bottom-wrap">
                    ...
                    <div class="button-groups add-button clearfix add-links">
                        ...
                        <?php if( class_exists( 'YITH_Woocompare' ) ) { ?>
                            ...
                            ?>
                            <div class="yith-compare btn btn-outline">
