...
<body <?php body_class(); ?>>
    ...
    <section class="wpo-wrapper <?php echo isset($meta_template['el_class']) ? esc_attr( $meta_template['el_class'] ) : '' ; ?>">
        ...
        <!-- Top bar -->
        <section id="wpo-topbar" class="wpo-topbar skin-mobile">
            <div class="container">
                ...
                <div class="topbar-inner hidden-sm hidden-xs">
                    
                    <div class="user-login pull-left topbar-left">
                        <div class="hidden-xs">
                            <?php if( !is_user_logged_in() ){ ?>
                                <span class="title"><?php echo __('Welcome visitor you can',TEXTDOMAIN); ?>
                            ...
                            <?php }else{ ?>
                                ...
                                <span class="title"><?php echo __('Welcome ',TEXTDOMAIN); ?><?php echo $current_user->display_name; ?> !</span>
                            <?php } ?>
                        </div>
                    ...
                    <div class="topbar-quick-settings pull-right">
                ...
                <div class="header-wrapper">
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="logo-in-theme pull-left">
                                    ...
                                    <?php } else { ?>
                                        <div class="logo logo-theme">
                                            <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
                                                 <img src="<?php echo get_template_directory_uri() . '/images/logo-mobile.png'; ?>" alt="<?php bloginfo( 'name' ); ?>" />
                                            </a>
                                        </div>
                                    <?php } ?>
                                </div>
                            ...
                            <div class="col-xs-9 header-right hidden-xs hidden-sm">
                ...
                <div class="wpo-mainmenu-header">
                    <div class="container">
                        <div class="mainmenu-content"> 
                            ...
                            <nav id="wpo-mainnav" data-duration="<?php echo wpo_theme_options('megamenu-duration',400); ?>" class="pull-left wpo-megamenu <?php echo wpo_theme_options('magemenu-animation','slide'); ?> animate navbar navbar-mega" role="navigation">
                                <div class="navbar-header">
                                    <?php wpo_renderButtonToggle(); ?>
                            ...
                            <div class="search pull-right hidden-sm">
                                <?php get_search_form(); ?>
                            </div>
                        </div>  
                    </div>
