...
<div style="display:none;" class="nicht-eu-shipping-hinweis"><small>Bei Lieferung in L&auml;nder au&szlig;erhalb der EU k&ouml;nnen zus&auml;tzlich zum Kaufpreis l&auml;nderspezifische Einfuhrabgaben und Z&ouml;lle anfallen, die der K&auml;ufer zu tragen hat.</small></div>
<div class="calculator"> 
	<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">

		<h2><a href="#" class="shipping-calculator-button btn btn-outline"><?php _e( 'Versandkosten berechnen', 'woocommerce' ); ?></a></h2>
		...
		<section class="shipping-calculator-form">
			...
			<p><button type="submit" name="calc_shipping" value="1" class="btn btn-outline btn-lg">Gesamtsumme aktualisieren</button></p>
