        ...
        <?php foreach( $parent_cat as $cat_id ):
            $i++;
                ...
                <!-- <div class="panel panel-default"> -->
                    <div class="category-title" role="tab" id="category-<?php echo $cat_id; ?>">
                        ...
                        <?php if($show_dropdown && $show_children && !empty($sub_cats) ){ ?>
                            <a class="collapsed dropdown" data-toggle="collapse" data-parent="#wpo-accordion-categories" href="#collapse-<?php echo $cat_id; ?>" aria-expanded="true" aria-controls="collapse-<?php echo $cat_id; ?>">
                                <i class="fa fa-plus-square"></i>
                            </a>
                        <?php } ?>
                        <?php if($show_children){
                            if( $sub_cats && !empty($sub_cats)){ ?>
                            <div id="collapse-<?php echo $cat_id; ?>" class="panel-collapse collapse <?php echo ($i==1?'in':''); ?> " role="tabpanel" aria-labelledby="category-<?php echo $cat_id; ?>">
                            <?php
