...
<p><?php printf( __( 'Du hast eine neue Bestellung erhalten von %s. Die Details anbei:', 'woocommerce' ), $order->billing_first_name . ' ' . $order->billing_last_name ); ?></p>
...
?>
<p style="font-size:20px;"><?php echo 'Anmerkung des Kunden: '; echo $note;?></p>
