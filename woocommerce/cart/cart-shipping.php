...
<tr class="shipping">
	<th><?php
		if ( $show_package_details ) {
			...
			_e( 'Versand- und Verpackungskosten', 'woocommerce' );
		}
	?></th>
	<td>
		<?php if ( ! empty( $available_methods ) ) : ?>
			...
			<?php if ( 1 === count( $available_methods ) ) :
				...
				function wc_cart_totals_shipping_method_label_2( $method ) {
					$label = '';
				...
				echo wp_kses_post( wc_cart_totals_shipping_method_label_2( $method ) ); ?>
